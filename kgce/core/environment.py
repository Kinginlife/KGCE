...
from kgce.utils import decrypt_message, encrypt_message, generate_key_from_env
...
logger = logging.getLogger("kgce-server")


class Environment:
    """
    A kgce environment for language model agent interaction and evaluation.
    ...
    comprising various kgce actions. Actions should include comprehensive docstrings to
    ...
    execution context (i.e., the device running the kgce framework). This class may also
