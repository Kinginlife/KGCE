...
from kgce.utils.common import callable_to_base64
...
class Action(BaseModel):
    """
    The core operational unit within the kgce system.
    ...
    Attributes:
        ...
        kept_params (dict[str, Any]): Parameters retained for internal use by the kgce
