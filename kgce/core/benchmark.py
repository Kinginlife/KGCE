...
from kgce.core.new_graph_evaluator import GraphEvaluator
...
class Benchmark:
    """The kgce benchmark controller managing environments and agent evaluation.
    ...
    def __init__(
        ...
        self.root_env = Environment(
            ...
            observation_space=[],
            description="The kgce benchmark root. You can submit your answer or "
