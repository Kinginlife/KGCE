...
You are a wise operator who is familiar with both the windows and Android operating
...
class TaskGenerator:
    ...
    def __init__(
        ...
        api_key="bce-v3/ALTAK-bOjQZN5ZU23sOsi29Zy5e/54577b5424991ea9965e787f1caf2a2a77154c83"
...
def load_subtasks(version):
    ...
    a_subtasks_module = importlib.import_module(
        f"benchmarks.kgce-benchmark-{version}.subtasks.a_subtasks"
    )
    u_subtasks_module = importlib.import_module(
        f"benchmarks.kgce-benchmark-{version}.subtasks.u_subtasks"
    )
...
def main():
    parser = argparse.ArgumentParser(description="Task Generator for kgce Benchmarks")
    parser.add_argument(
