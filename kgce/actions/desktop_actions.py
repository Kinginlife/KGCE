...
from kgce import action

from .kgce_actions import get_element_position
...
def double_click(element: int, env) -> None:
    ...
    usually used for opening a folder a file or an application . A simple use case can be
...
def search_application(name: str) -> None:
    """
    Search an application name. For example, if you want to open an application named
    "slack", you can call search_application(name="Google"). You MUST use this action to
    search for applications.
