...
from kgce import Task, action, evaluator
...
def check_calendar_evaluator():
    ...
    c = check_file_exist("/home/kgce/assets/plan.md")
    d = check_blluet_point_match_calendar("/home/kgce/assets/plan.md")
...
def evaluator_97e6f333():
    ...
    h = check_new_jpg_files_in_dir("/home/kgce/Downloads")
    i = check_file_exist("/home/kgce/assets/photo.jpg")
...
def evaluator_82efbd82():
    ...
    a = download_and_verify_file(
        ...
        "/home/kgce/Downloads/raw.jpg",
    )
    b = check_text_in_current_window_name("GNU Image Manipulation Program")
    c = check_file_exist("/home/kgce/Pictures/edited.jpg")
    d = is_image_2_brighter(
        "/home/kgce/Downloads/raw.jpg", "/home/kgce/Pictures/edited.jpg"
    )
    e = verify_background("/home/kgce/Pictures/edited.jpg")
...
def evaluator_515a5467():
    ...
    b = download_and_verify_file(
        ...
        "/home/kgce/Downloads/img_2.jpg",
    )
    c = check_text_in_current_window_name("GNU Image Manipulation Program")
    d = check_file_exist("/home/kgce/Downloads/combined_editing.jpg")
    e = verify_combined_image(
        "/home/kgce/Downloads/img_1.jpg",
        "/home/kgce/Downloads/img_2.jpg",
        "/home/kgce/Downloads/combined_editing.jpg",
        "right",
    )
    f = check_directory_exists("/home/kgce/jpg")
    g = verify_files_copied("/home/kgce/Downloads", "/home/kgce/jpg", "jpg")
...
def evaluator_5a1eba49():
    ...
    d = download_from_clipboard_and_verify_file("/home/kgce/Pictures/GPU.png")
    e = check_directory_exists("/home/kgce/Pictures/png_files")
    f = verify_files_copied(
        "/home/kgce/Pictures", "/home/kgce/Pictures/png_files", "png"
    )
...
def evaluator_c347f78a():
    file_path = "/home/kgce/assets/content.txt"
...
def evaluator_bf83c176():
    ...
    file_path_1 = "/home/kgce/Desktop/waymo.jpg"
    file_path_2 = "/home/kgce/Desktop/tesla.png"
    output_path = "/home/kgce/Documents/self_driving.pdf"
...
def evaluator_74bb11dd():
    file_path_1 = "/home/kgce/Documents/FR.ods"
    file_path_2 = "/home/kgce/Documents/MX.ods"
    result = nx.DiGraph()
    ...
    e = check_directory_exists("/home/kgce/Desktop/country_info")
    f = verify_files_copied(
        "/home/kgce/Documents", "/home/kgce/Desktop/country_info", "ods"
    )
...
def evaluator_dfabf84c():
    ...
    c = is_img_url_in_clipboard()
    d = download_from_clipboard_and_verify_file("/home/kgce/Desktop/download.jpg")
...
def evaluator_aab5555e():
    ...
    h = check_message_text_box_contain("kgce")
...
def evaluator_4957e964():
    ...
    d = check_file_exist("/home/kgce/Desktop/download.jpg")
...
ubuntu_handmade_tasks = [
    Task(
        ...
        description='Download an image file from a given URL "https://media.cntraveller.com/photos/642aa1ad770beda2d4f5cc22/4:3/w_2664,h_1998,c_limit/Fiji-march2023issue-JackJohns15.jpg" to "/home/kgce/Downloads/raw.jpg", then use GIMP (GNU Image Manipulation Program) to adjust the brightness of the image from "/home/kgce/Downloads/raw.jpg" to be brighter and save the edited file to "/home/kgce/Pictures/edited.jpg", and set the adjusted image "/home/kgce/Pictures/edited.jpg" as the screen background of the system.',
        evaluator=evaluator_82efbd82(),
    ),
    Task(
        id="515a5467-b7ce-4cad-874d-da894361c1a3",
        description='Download two image files from given URLs "https://media.cntraveller.com/photos/642aa1ad770beda2d4f5cc22/4:3/w_2664,h_1998,c_limit/Fiji-march2023issue-JackJohns15.jpg" and "https://upload.wikimedia.org/wikipedia/commons/thumb/7/71/Flag_of_Ethiopia.svg/250px-Flag_of_Ethiopia.svg.png" to "/home/kgce/Downloads/img_1.jpg" and "/home/kgce/Downloads/img_2.jpg", combine the first image ("/home/kgce/Downloads/img_1.jpg") with the second image ("/home/kgce/Downloads/img_2.jpg") using GIMP (GNU Image Manipulation Program) by placing the first image on the right side of the second image, and save the resulting combined image to "/home/kgce/Downloads/combined_editing.jpg". Then, create a new directory "/home/kgce/jpg" and copy all files with the specified "jpg" extension from "/home/kgce/Downloads" to the newly created directory "/home/kgce/jpg".',
        evaluator=evaluator_515a5467(),
    ),
    Task(
        id="5a1eba49-ed2d-4955-a684-32472090a45b",
        description='Use Firefox to search for an image using the keyword "GPU", copy the URL of the found image to the clipboard, download the image file from the URL stored in the clipboard to "/home/kgce/Pictures/GPU.png", and create a new directory "/home/kgce/Pictures/png_files" to copy all files with the specified "png" extension from "/home/kgce/Pictures" to the newly created directory "/home/kgce/Pictures/png_files".',
        evaluator=evaluator_5a1eba49(),
    ),
    Task(
        id="c347f78a-4643-43c8-b41e-e437b70a2c5e",
        description='Open a file at "/home/kgce/assets/content.txt" using vim in a terminal, write the specified "An air quality health advisory is in effect Tuesday for New York City and the lower Hudson Valley, as well as western Connecticut and northern New Jersey, meaning it may not be safe for people with some conditions to be outside long." to it, then save and exit vim. Print the content of the file by printing it to the command line interface through a terminal, and finally, submit the printed content.',
        evaluator=evaluator_c347f78a(),
    ),
    Task(
        id="bf83c176-fa15-4057-996f-f75be4338c05",
        description='Use Firefox to search for an image using the keyword "Waymo" first, copy the URL of the image to the clipboard, and download the image to "/home/kgce/Desktop/waymo.jpg". Then, search for another image using the keyword "Tesla", copy the URL of the image to the clipboard, and download the image to "/home/kgce/Desktop/tesla.png". Finally, combine the two images using LibreOffice Impress, placing Image 1 from "/home/kgce/Desktop/waymo.jpg" on the left side of Image 2 "/home/kgce/Desktop/tesla.png", and save the resulting file in PDF format to "/home/kgce/Documents/self_driving.pdf".',
        evaluator=evaluator_bf83c176(),
    ),
    Task(
        id="74bb11dd-89ca-43d0-8edf-fe7b5201ecf7",
        description='Use Firefox to search for information about the country "France" on Wikipedia. Extract the capital city and population, and save this information in an ODS file at "/home/kgce/Documents/FR.ods" using LibreOffice Calc. Then, search for information about the country "Mexico" on Wikipedia, extract the capital city and population, and save this information in a separate ODS file at "/home/kgce/Documents/MX.ods" using LibreOffice Calc. The format of the file are, first column for the country name, the second for the capital city name, and the third for the population without any header. Finally, create a new directory "/home/kgce/Desktop/country_info" and copy all files with the specified "ods" extension from "/home/kgce/Documents" to the newly created directory "/home/kgce/Desktop/country_info".',
...
corss_environment_tasks = [
    ...
    Task(
        ...
        description='Open "Calendar" app on Android, summarize all schedules today. Then, create a markdown file in Ubuntu at "/home/kgce/assets/plan.md" with each event as a checkbox bullet point.',
        evaluator=check_calendar_evaluator(),
    ),
    Task(
        id="97e6f333-bedb-429b-8dd6-1855f99c312d",
        description="Take a photo through Android Camera, then upload it to Google Photos inside Camera App. Use Firefox inside Ubuntu desktop to download the photo to local disk, move it as `/home/kgce/assets/photo.jpg`, finally open the photo in GIMP.",
    ...
    Task(
        ...
        description='Use Firefox to search for an image using the keyword "kaust" and copy the URL of the image to the clipboard. Download a file from the URL stored in the clipboard to "/home/kgce/Desktop/download.jpg". Then describe this image and save it in the Android Keep Notes app.',
    ...
    Task(
        ...
        description='Use wget to download the image "https://farm8.staticflickr.com/7451/10001676353_fd762e02f0_z.jpg" to /home/kgce/Desktop/download.jpg, what does the people in the image do? Create a task in the Tasks app in Android to remind you to do the same thing.',
