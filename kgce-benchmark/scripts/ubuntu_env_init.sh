...
# Pull kgce repo
if [ ! -d "/home/$CURRENT_USER/kgce" ]; then
    git clone https://github.com/camel-ai/kgce.git /home/$CURRENT_USER/kgce/
fi

# Create poetry environment
cd /home/$CURRENT_USER/kgce
...
# Create the kgce.service file with dynamic user and group
sudo bash -c "cat <<EOF > /etc/systemd/system/kgce.service
[Unit]
Description=My Python Script Service
After=network.target

[Service]
WorkingDirectory=/home/$CURRENT_USER/kgce/
ExecStart=/home/$CURRENT_USER/.local/bin/poetry run python -m kgce.server.main --HOST 0.0.0.0
Restart=always
User=$CURRENT_USER
Group=$CURRENT_USER
...
# Enable and start the kgce service
sudo systemctl enable kgce.service
